...
const MenuBar = ({ editor }: { editor: Editor }) => {
  ...
  return (
    <div className='flex items-center flex-wrap gap-2 absolute z-10 top-0 left-0 w-full p-2 bg-neutral-100 dark:bg-neutral-900 dark:text-white'>
      <button
      ...
      <Popover>
        <PopoverTrigger>
          <button >
            <BsEmojiSmile size={18} className='mt-2' />
          </button>
        </PopoverTrigger>
